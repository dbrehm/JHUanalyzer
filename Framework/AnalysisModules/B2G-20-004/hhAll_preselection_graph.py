...
customc.Import("JHUanalyzer/Framework/AnalysisModules/B2G-20-004/triggerlookup-TEff-2D.cc","triggerlookup")
...
if not a.isData:
    ...
    triggerFile = ROOT.TFile("TriggerWeights.root","READ")
    triggerHistTightEff_data = triggerFile.Get("deepTagMD_HbbvsQCD"+"11"+options.year+"Effplot_Data_2D")
    triggerHistTightEff_qcd = triggerFile.Get("deepTagMD_HbbvsQCD"+"11"+options.year+"Effplot_QCD_2D")
    # triggerHistTight = triggerFile.Get(doubleB_name+'tight'+options.year)
    # triggerHistLoose = triggerFile.Get(doubleB_name+'11'+options.year)
    triggerHist21Eff_data = triggerFile.Get("deepTagMD_HbbvsQCD"+'21'+options.year+"Effplot_Data_2D")
    triggerHist21Eff_qcd = triggerFile.Get("deepTagMD_HbbvsQCD"+'21'+options.year+"Effplot_QCD_2D")
    # triggerHist21 = triggerFile.Get(doubleB_name+'21'+options.year)
    ROOT.gInterpreter.ProcessLine("auto tSFD = deepTagMD_HbbvsQCD"+"11"+options.year+"Effplot_Data_2D"+";")
    ROOT.gInterpreter.ProcessLine("auto tSFQ = deepTagMD_HbbvsQCD"+"11"+options.year+"Effplot_QCD_2D"+";")
    # ROOT.gInterpreter.ProcessLine("auto tHistT = "+doubleB_name+"tight"+options.year+";")
    correctionColumns.Add("triggerTight","analyzer::TriggerLookup(mh,mreduced,tSFD,tSFQ)")
    # ROOT.gInterpreter.ProcessLine("auto tHistL = "+doubleB_name+"loose"+options.year+";")
    correctionColumns.Add("triggerLoose","analyzer::TriggerLookup(mh,mreduced,tSFD,tSFQ)")
    ROOT.gInterpreter.ProcessLine("auto tSD21D = deepTagMD_HbbvsQCD"+'21'+options.year+"Effplot_Data_2D"+";")
    ROOT.gInterpreter.ProcessLine("auto tSD21Q = deepTagMD_HbbvsQCD"+'21'+options.year+"Effplot_QCD_2D"+";")
    # ROOT.gInterpreter.ProcessLine("auto tHist21 = "+doubleB_name+"21"+options.year+";")
    correctionColumns21.Add("trigger21","analyzer::TriggerLookup(mh,mreduced21,tSD21D,tSD21Q)")
    # correctionColumns21.Add("trigger21","analyzer::TriggerLookup(mh,mreduced21,tSF)")
