// Stolen from TIMBER (hence references to TIMBER)
// link to git repo: https://github.com/lcorcodilos/TIMBER.git
...
LumiFilter::LumiFilter(int year){
    if (year == 17 or year == 2017) {
        boost::property_tree::read_json(std::string("JHUanalyzer/Framework/AnalysisModules/B2G-20-004/LumiJSON/Cert_294927-306462_13TeV_EOY2017ReReco_Collisions17_JSON.txt"), ptree);
    } else if (year == 18 or year == 2018) {
        boost::property_tree::read_json(std::string("JHUanalyzer/Framework/AnalysisModules/B2G-20-004/LumiJSON/Cert_314472-325175_13TeV_17SeptEarlyReReco2018ABC_PromptEraD_Collisions18_JSON.txt"), ptree);
    } else {
